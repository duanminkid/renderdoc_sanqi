# AGENTS.md — SanQi Capture (RenderDoc Fork)
...
- See `~/.Codex/AGENTS.md` for Harness Engineering SOP (global enforcement)
- See `~/.Codex/harness/SOP.md` for full SOP specification
- Never commit without explicit user request (see global AGENTS.md)
...
- **路径规则**: `.Codex/rules/software/api.md`, `core.md`, `db.md`, `tests.md`
- **全局约束**: `~/.Codex/AGENTS.md` (Harness Engineering SOP), `~/.Codex/rules/harness/` (通用规则), `~/.Codex/rules/harness/languages/cpp.md`
